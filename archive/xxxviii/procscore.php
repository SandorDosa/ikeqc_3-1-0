...
$seta = mysql_query("SELECT * FROM $pgyear WHERE $pgyear.div='A' AND ( $pgyear.seen='Y' || $pgyear.seen='D' ) ORDER BY PID,score DESC", $db);
        IF ($seta) {
...
$seta = mysql_query("SELECT * FROM $pgyear WHERE $pgyear.div='B' AND ( $pgyear.seen='Y' || $pgyear.seen='D' ) ORDER BY PID,score DESC", $db);
        IF ($seta) {
            IF (mysql_num_rows($seta) > 1) {
                IF ($A = mysql_fetch_row($seta)) {
                    do {
...
$seta = mysql_query("SELECT * FROM $pgyear WHERE $pgyear.div='C' AND ( $pgyear.seen='Y' || $pgyear.seen='D' ) ORDER BY PID,score DESC", $db);
        IF ($seta) {
            IF (mysql_num_rows($seta) > 1) {
                IF ($A = mysql_fetch_row($seta)) {
                    do {
...
$seta = mysql_query("SELECT * FROM $pgyear WHERE $pgyear.div='D' AND ( $pgyear.seen='Y' || $pgyear.seen='D' ) ORDER BY PID,score DESC", $db);
        IF ($seta) {
            IF (mysql_num_rows($seta) > 1) {
                IF ($A = mysql_fetch_row($seta)) {
                    do {
...
$seta = mysql_query("SELECT * FROM $pgyear WHERE $pgyear.div='E' AND ( $pgyear.seen='Y' || $pgyear.seen='D' ) ORDER BY PID,score DESC", $db);
        IF ($seta) {
            IF (mysql_num_rows($seta) > 1) {
                IF ($A = mysql_fetch_row($seta)) {
                    do {
...
$seta = mysql_query("SELECT * FROM $pgyear WHERE $pgyear.div='F' AND ( $pgyear.seen='Y' || $pgyear.seen='D' ) ORDER BY PID,score DESC", $db);
        IF ($seta) {
            IF (mysql_num_rows($seta) > 1) {
                IF ($A = mysql_fetch_row($seta)) {
                    do {
