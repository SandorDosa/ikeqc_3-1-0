...
<body>
<H1>A.S. XL</H1>
<H2>XXXX or XL is still the fourth year we've done this :)</H2>
...
IF (isset($NEWREC)) {
  ...
  do {
    IF ($L = mysql_fetch_row($setba)) {
      IF ($L[2] == $Ename) {
        echo "<H2>You are trying to add an event that already exists.</H2><BR>Process terminated.<BR>If you meant to EDIT an event, click back and click the button to ALTER EVENT to submit your changes.\n";
        die;
      }
    }
...
<TABLE Border=1>
 ...
 <TR>
  ...
  In order to both controll outside access to the database and to keep tabs on things internally.  You can manually assign a password or use the randomly generated one already displayed.
  </P>
