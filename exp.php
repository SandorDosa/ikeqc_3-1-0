...
print "Reports should outline their methods and findings with reguards to making varitions on the rules as they existed prior to AS LII.  In particular experiments about the two-handed variation are particularly desired.</p>\n";
print "<a href=\"old_birjas.pdf\">Click here to download an archive of the old Birjas rules</a>.\n";
print "<hr>\n";
