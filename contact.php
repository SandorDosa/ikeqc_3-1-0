...
print "<p>All general inquiries should be sent to ikeqc (at) scaikeqc (dot) org.<br>\n";
print "Any urgent query can be sent to lord (dot) sandor (dot) dosa (at) gmail and he will forward it on for action.<hr>\n";
