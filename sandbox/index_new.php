        ...
        do {
            SWITCH ($FA[0]) {
                CASE 1:
                    ...
                    $count = 0;
                    $A = mysqli_query($db_alt, "SELECT riders.Pname,heads_short.SHSscore,heads_short.DVN FROM riders LEFT JOIN heads_short ON riders.PID = heads_short.PID WHERE heads_short.SHSseen = 'Y' ORDER BY heads_short.SHSscore LIMIT 5");
                ...
                CASE 2:
                    ...
                    print "<div class='w3-centered'><table style='margin: 0 auto;'>\n";
                    $count = 0;
                    $A = mysqli_query($db_alt, "SELECT riders.Pname,heads_long.SHLscore,heads_long.DVN FROM riders LEFT JOIN heads_long ON riders.PID = heads_long.PID WHERE heads_long.SHLseen = 'Y' ORDER BY heads_long.SHLscore LIMIT 5");
                    IF ($AA = mysqli_fetch_array($A)) {
                        do {
                            print "<tr><td class='w3-left-align'>{$AA[0]}</td><td class='w3-right-align'>{$AA[1]}</td>";
                            SWITCH ($AA[2]) {
                ...
                CASE 3:
                    ...
                    print "<div class='w3-centered'><table style='margin: 0 auto;'>\n";
                    $count = 0;
                    $A = mysqli_query($db_alt, "SELECT riders.Pname,rings.SRscore,rings.DVN FROM riders LEFT JOIN rings ON riders.PID = rings.PID WHERE rings.SRseen = 'Y' ORDER BY rings.SRscore LIMIT 5");
                    IF ($AA = mysqli_fetch_array($A)) {
                        do {
                            print "<tr><td class='w3-left-align'>{$AA[0]}</td><td class='w3-right-align'>{$AA[1]}</td>";
                            SWITCH ($AA[2]) {
                ...
                CASE 4:
                    ...
                    print "<div class='w3-centered'><table style='margin: 0 auto;'>\n";
                    $count = 0;
                    $A = mysqli_query($db_alt, "SELECT riders.Pname,reeds.SDscore,reeds.DVN FROM riders LEFT JOIN reeds ON riders.PID = reeds.PID WHERE reeds.SDseen = 'Y' ORDER BY reeds.SDscore LIMIT 5");
                    IF ($AA = mysqli_fetch_array($A)) {
                        do {
                            print "<tr><td class='w3-left-align'>{$AA[0]}</td><td class='w3-right-align'>{$AA[1]}</td>";
                            SWITCH ($AA[2]) {
                ...
                CASE 5:
                    ...
                    print "<div class='w3-centered'><table style='margin: 0 auto;'>\n";
                    $count = 0;
                    $A = mysqli_query($db_alt, "SELECT riders.Pname,ma_single.SMSscore,ma_single.DVN FROM riders LEFT JOIN ma_single ON riders.PID = ma_single.PID WHERE ma_single.SMSseen = 'Y' ORDER BY ma_single.SMSscore LIMIT 5");
                    IF ($AA = mysqli_fetch_array($A)) {
                        do {
                            print "<tr><td class='w3-left-align'>{$AA[0]}</td><td class='w3-right-align'>{$AA[1]}</td>";
                            SWITCH ($AA[2]) {
                ...
                CASE 6:
                    ...
                    print "<div class='w3-centered'><table style='margin: 0 auto;'>\n";
                    $count = 0;
                    $A = mysqli_query($db_alt, "SELECT riders.Pname,ma_triple.SMTscore,ma_triple.DVN FROM riders LEFT JOIN ma_triple ON riders.PID = ma_triple.PID WHERE ma_triple.SMTseen = 'Y' ORDER BY ma_triple.SMTscore DESC LIMIT 5");
                    IF ($AA = mysqli_fetch_array($A)) {
                        do {
                            print "<tr><td class='w3-left-align'>{$AA[0]}</td><td class='w3-right-align'>{$AA[1]}</td>";
                            SWITCH ($AA[2]) {
